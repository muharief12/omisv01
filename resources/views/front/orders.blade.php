...
<body>
    ...
    <section class="wrapper flex flex-col gap-2.5">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="py-3.5 pl-4 pr-[22px] bg-white border-l-4 border-bg-red rounded-2xl flex gap-1 items-center relative">
                ...
                <div class="flex flex-wrap items-center justify-between w-full gap-1">
                    <div class="flex flex-col gap-1">
                        <a href="{{ route('order_detail', $order->code)}}" class="text-base font-semibold stretched-link whitespace-nowrap w-[150px] truncate">
                            {{ $order->code }}
                        </a>
            ...
            @empty
            <p class="text-center text-red-500">The order data isn't ready</p>
            @endforelse
        </div>
    </section>
