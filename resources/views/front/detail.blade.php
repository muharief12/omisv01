...
<body>
  ...
  <section class="bg-white rounded-t-[60px] pt-[60px] px-6 pb-5 -mt-9 flex flex-col gap-5 max-w-[425px] mx-auto">
    ...
    <div class="flex items-center justify-between">
      ...
      @guest
      <a href="{{ route('login')}}" class="inline-flex w-max text-white font-bold text-base bg-primary rounded-full px-[30px] py-3 justify-center items-center whitespace-nowrap">
        Add to Cart
      </a>
      @endguest
      @auth
