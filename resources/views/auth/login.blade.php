  ...
  <div class="flex flex-col items-center px-6 py-10 min-h-dvh">
    ...
    <form action="{{ route('login')}}" method="POST" class="mx-auto max-w-[345px] w-full p-6 bg-white rounded-3xl mt-auto" id="deliveryForm">
      ...
      <div class="flex flex-col gap-5">
        ...
        <button type="submit" class="inline-flex text-white font-bold text-base bg-primary rounded-full whitespace-nowrap px-[30px] py-3 justify-center items-center" onclick="window.location.href='/public/pages/index.html'">
          Sign In
        </button>
      </div>
    </form>
