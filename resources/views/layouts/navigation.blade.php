        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @role('owner')
                    ...
                    <!-- Admin Fee Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('admin.admin_fees.index')" :active="request()->is('admin/admin_fees*')">
                            {{ __('Admin Fees') }}
                        </x-nav-link>
                    </div>
                @endrole
                
                <!-- Product Transaction Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('product_transactions.index')" :active="request()->is('product_transactions*')">
