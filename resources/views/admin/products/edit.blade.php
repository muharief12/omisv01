                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" value="{{$product->price }}" required autofocus autocomplete="Product Price" />
                        ...
                        <div class="mt-4">
                            ...
                            <img src="{{ Storage::url($product->photo)}}" alt="{{ $product->name}} photo" class="w-[50px]">
                            <x-text-input id="photo" class="block mt-1 w-full" type="file" name="photo" autofocus autocomplete="Product photo" />
